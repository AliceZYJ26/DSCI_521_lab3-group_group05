...
## Where did you live before MDS, and what is one thing you miss about it? {.smaller}
...
## What did you do before MDS: a degree, a job, or both? {.smaller}
...
## What made you apply to MDS? {.smaller}
...
## What is one thing you want to be able to do by the end of the program? {.smaller}
...
::: {.column width="50%"}
![Alice Zhang's Merge Conflict 1](images/alice26_image_1.png)
:::
...
![Yuhao Gao's Merge Conflict](images/gyh072.png)